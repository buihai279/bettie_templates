...
(function(f, g, k) {
    var l = {
        ...
        setVars: function() {
            ...
            this.$owlWrapper = this.$elem.find(".owl-stage");
        ...
        onStartup: function() {
            ...
            this.play();
            this.$elem.find(".owl-stage").css("display", "block");
        ...
        wrapItems: function() { this.$userItems.wrapAll('<div class="owl-stage">').wrap('<div class="owl-item"></div>');
            this.$elem.find(".owl-stage").wrap('<div class="owl-stage-outer">');
            this.wrapperOuter = this.$elem.find(".owl-stage-outer");
        ...
        updateItems: function() {
            ...
            if (!1 !== this.options.itemsCustom)
                for (this.options.itemsCustom.sort(function(a, b) {
                        return a[0] - b[0] }), b = 0; b < this.options.itemsCustom.length; b += 1) this.options.itemsCustom[b][0] <= a && (this.options.items = this.options.itemsCustom[b][1]);
        ...
        buildButtons: function() {
            var a = this,
                b = f('<div class="owl-nav"/>');
            a.owlControls.append(b);
            a.buttonPrev =
                f("<div/>", { "class": "owl-prev fa fa-angle-left", html: a.options.navigationText[0] || "" });
            a.buttonNext = f("<div/>", { "class": "owl-next fa fa-angle-right", html: a.options.navigationText[1] || "" });
        ...
        gestures: function() {
            ...
            d.isCssFinish = !0;
            d.$elem.on(d.ev_types.start, ".owl-stage", function(c) {
        ...
        stopOnHover: function() {
            var a = this;!0 === a.options.stopOnHover && !0 !== a.browser.isTouch && !1 !== a.options.autoPlay && (a.$elem.on("mouseover", function() { a.stop() }), a.$elem.on("mouseout", function() { "stop" !== a.hoverStatus && a.play() })) },
        lazyLoad: function() {
            var a, b, e, c, d;
